...
public class LoanHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HistoryData loan = new HistoryData(this);
            ...
            case R.id.logout:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dialog.dismiss();
                        stopService(new Intent(LoanHistoryActivity.this, IService.class));
                        Intent intent = new Intent(LoanHistoryActivity.this, LoginActivity.class);
